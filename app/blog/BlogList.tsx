  ...
  return (
    <section>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-bold uppercase tracking-wide text-[#d9a441]">Tech insights</p>
          <h2 className="mt-2 text-2xl font-bold text-[#073b7a]">Latest laptop and IT guides</h2>
        </div>
      ...
      {visiblePosts.length > 0 ? (
        ...
        <div className="mt-6 rounded bg-white p-8 text-center ring-1 ring-blue-100">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Try searching for laptop, SSD, RAM, repair, accessories, or software.
          </p>
        </div>
      )}
    </section>
