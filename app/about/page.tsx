...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Ehi's Tech Computer Services, a trusted laptop sales, accessories, repairs, upgrades, and IT solutions company.",
  alternates: { canonical: "/about" },
  openGraph: {
    url: "/about",
    title: "About Ehi's Tech Computer Services",
    description:
      ...
      <section className="section-shell grid gap-10 py-16 lg:grid-cols-[1fr_0.9fr]">
        <div>
          <h2 className="text-3xl font-bold text-[#073b7a]">
            Computer services with structure, care, and accountability.
          </h2>
          <p className="mt-5 leading-8 text-slate-600">
            Ehi's Tech Computer Services helps customers buy reliable laptops, source useful
            accessories, repair faulty systems, upgrade slow computers, install software, and supply
            devices for schools, offices, and organizations.
          </p>
          <p className="mt-4 leading-8 text-slate-600">
            Whether you are a student, individual buyer, office, school, or organization, we make
            the buying and support process clearer and easier to follow.
          </p>
          <Link
            href="/apply-now"
