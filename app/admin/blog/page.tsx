...
export const metadata: Metadata = {
  ...
  description: "Protected blog management for Ehi's Tech Computer Services.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <section className="bg-[#073b7a] py-12 text-white">
        <div className="section-shell">
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-blue-100">
            Create, edit, publish, unpublish, and delete laptop, accessories, repair, upgrade, and
            IT support articles for the public blog.
          </p>
        </div>
      </section>
