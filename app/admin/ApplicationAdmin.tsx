    ...
    try {
      const response = await fetch(`/api/applications/${id}/notes`, {
        ...
        body: JSON.stringify({
          ...
          notifyCustomer: Boolean(notifyNotesById[id]),
        }),
      });
      ...
      setSuccess(
        data.notificationEmailSent
          ? "Admin notes saved and customer email sent."
          : "Admin notes saved."
      );
      ...
      <div className="mt-4 rounded bg-[#f4f8ff] p-3 ring-1 ring-blue-100">
        <label className="grid gap-2 text-xs font-bold uppercase tracking-wide text-[#073b7a]">
          ...
          <textarea
            ...
            placeholder="Write the latest note for this customer..."
            maxLength={5000}
          />
        </label>
        <label className="mt-3 flex items-center gap-2 text-xs font-semibold text-slate-700">
          ...
          />
          Email customer about this note
        </label>
        <button
          type="button"
    ...
    return (
      <div className="grid gap-5">
        ...
        <div className="rounded bg-white p-8 text-center shadow-sm ring-1 ring-blue-100 md:p-12">
          ...
          <h2 className="mt-5 text-xl font-bold text-[#073b7a]">No requests yet</h2>
          <p className="mt-2 text-sm text-slate-600">
            New request submissions, tracking codes, uploaded files, and status controls will
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead className="bg-[#073b7a] text-white">
            <tr>
              ...
              <th className="px-4 py-3 font-bold">Need</th>
              ...
              <tr key={application.id} className="border-t border-blue-100 align-top">
                ...
                <td className="px-4 py-4">
                  ...
                  <p className="mt-1 font-semibold text-slate-700">
                    {application.purposeOfTravel ?? "Category not specified"}
                  </p>
          ...
          <article key={application.id} className="rounded bg-white p-5 shadow-sm ring-1 ring-blue-100">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                aria-label={`Delete request from ${application.fullName}`}
              >
            ...
            <dl className="mt-4 grid gap-3 text-sm">
              ...
              <div>
                <dt className="font-bold text-slate-700">Product or service needed</dt>
                <dd className="mt-1 text-slate-600">{application.destinationCountry}</dd>
              </div>
              <div>
                <dt className="font-bold text-slate-700">Request category</dt>
                <dd className="mt-1 text-slate-600">
                  {application.purposeOfTravel ?? "Category not specified"}
                </dd>
              </div>
              <div>
                <dt className="font-bold text-slate-700">Usage or support type</dt>
