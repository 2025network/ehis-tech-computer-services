...
export const metadata: Metadata = {
  title: "Admin Login",
  description: "Secure admin login for Ehi's Tech Computer Services request and product management.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <section className="section-shell grid min-h-screen items-center gap-10 py-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold leading-tight text-[#073b7a] sm:text-5xl">
            Secure access for request management.
          </h2>
          <p className="mt-5 max-w-xl text-base leading-7 text-slate-700">
            Manage customer requests, uploaded files, tracking codes, product inquiries, and status
            updates from one professional dashboard.
          </p>
          <div className="mt-8 rounded bg-[#073b7a] p-5 text-white ring-1 ring-blue-200">
            ...
            <p className="mt-2 text-sm leading-6 text-blue-100">
              Protected access keeps request review and customer management private.
            </p>
          </div>
        </div>
