...
const business = {
  ...
  website: "https://ehistech.com",
  address: "Shop 30, Computer Village, Ikeja, Lagos, Nigeria",
};

const storageKey = "ehis-tech-marketing-studio-history";

const styleThemes: Record<FlyerStyle, { headline: string; accent: string; background: string; offer: string }> = {
  "Professional Corporate": {
    headline: "Professional Laptop & IT Support",
    accent: "#0b4ea2",
    background: "#f4f8ff",
    offer: "Clear guidance. Organized details. Trusted support.",
  },
  "Modern IT": {
    headline: "Plan Your Next Computer Setup With Confidence",
    accent: "#0f766e",
    background: "#ecfeff",
    offer: "IT support designed for modern customers.",
  },
  "Premium Gold": {
    headline: "Premium Tech Support",
    accent: "#d9a441",
    background: "#fff7e6",
    offer: "Elegant preparation for important tech plans.",
  },
  "Tech Promotion": {
    headline: "Laptop & IT Support Now Available",
    accent: "#073b7a",
    background: "#eef5ff",
    offer: "Get detail guidance before you submit.",
  },
  "Corporate Supply": {
    headline: "Equip Your Team With Reliable Laptops",
    accent: "#2563eb",
    background: "#eff6ff",
    offer: "School, office, and organization laptop supply support.",
  },
  "Fast Repair": {
    headline: "Do Not Delay Your Device Repair",
    accent: "#dc2626",
    background: "#fff1f2",
    offer: "Act early. Organize details. Avoid last-minute stress.",
  },
  "Special Offer": {
    headline: "Special IT support Package",
    accent: "#7c3aed",
    background: "#f5f3ff",
    offer: "Ask about support for your laptop, accessory, or office setup needs.",
  },
};

const serviceAngles: Record<Service, string[]> = {
  "Laptop Sales": ["business laptop options", "student laptop guidance", "quality-tested devices"],
  "Laptop Accessories": ["chargers and adapters", "bags and keyboards", "complete laptop bundles"],
  "Laptop Repairs": ["screen and keyboard checks", "diagnostics and repair advice", "after-repair support"],
  "RAM/SSD Upgrades": ["speed improvement options", "storage expansion guidance", "upgrade compatibility checks"],
  "Software Installation": ["Windows and office setup", "driver installation", "essential productivity tools"],
  "Office Computer Setup": ["workstation planning", "network and printer setup", "team productivity support"],
  "Corporate Supply": ["bulk laptop sourcing", "school and office supply", "organization-ready documentation"],
  "IT Consultation": ["device need planning", "IT equipment checklist", "purchase and setup advice"],
  "Device Diagnostics": ["fault checks", "repair recommendations", "maintenance guidance"],
  "Accessory Bundles": ["charger and bag bundles", "keyboard and mouse sets", "work-from-home kits"],
  "Repair Follow-up": ["post-repair checks", "warranty reminders", "next-step support"],
  "General Tech Promotion": ["laptop readiness", "device need guidance", "end-to-end support"],
};
...
function makeHashtags(service: Service, platform: Platform) {
  ...
  return `#EhisTech #TechSupport #ITSolutions #${serviceTag} #${platformTag} #NigeriaTech`;
}
...
function makeCaption(service: Service, platform: Platform, index: number) {
  ...
  const platformLine: Record<Platform, string> = {
    ...
    Instagram: "Save this post and share it with someone planning to tech.",
    "WhatsApp Status": "Reply now if you need help preparing your details.",
    TikTok: "Use this as a quick tech-prep reminder before you apply.",
    LinkedIn: "Professional tech preparation starts with organized detailation.",
    "Google Business Profile": "Visit Ehi's Tech Computer Services for structured IT support.",
  };
...
function makeImageIdea(service: Service, style: FlyerStyle, index: number) {
  const ideas = [
    `${style} flyer with laptop, accessories, and organized workstation for ${service}`,
    `Clean checklist visual showing key ${service} details`,
    `tech desk scene with ${service} headline and blue-gold branding`,
...
function makeVideoIdea(service: Service, platform: Platform, index: number) {
  if (platform === "TikTok" || platform === "Instagram" || platform === "WhatsApp Status") {
    return `${index + 1}-point short video: details to prepare for ${service}.`;
  }
...
function downloadFlyer(service: Service, style: FlyerStyle) {
  ...
  context.fillText("Trusted Laptop Sales, Accessories & IT Solutions.", 70, 140);
...
export function MarketingStudio() {
  const [service, setService] = useState<Service>("Laptop Sales");
          ...
          <section className="rounded bg-white p-5 shadow-sm ring-1 ring-blue-100">
            ...
            >
              <div className="bg-[#073b7a] p-6 text-white">
                ...
                <p className="mt-2 text-sm text-blue-100">Trusted Laptop Sales, Accessories & IT Solutions.</p>
              </div>
              <div className="p-6">
