...
export const metadata: Metadata = {
  ...
  description: "Protected tech marketing studio for Ehi's Tech Computer Services.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <section className="bg-[#073b7a] py-12 text-white">
        <div className="section-shell">
          ...
          <h1 className="mt-3 text-4xl font-bold leading-tight sm:text-5xl">
            Tech Marketing Studio
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-blue-100">
            Generate branded flyers, platform-specific content, and reusable tech marketing
          ...
          {[
            {
              ...
              description: "Create branded tech advert layouts.",
              icon: Palette,
            },
            {
