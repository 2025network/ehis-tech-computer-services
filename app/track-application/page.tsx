...
export const metadata = {
  title: "Track Request",
  description:
    "Track your Ehi's Tech Computer Services laptop, repair, upgrade, accessory, or supply request using your tracking code.",
  alternates: { canonical: "/track-application" },
  openGraph: {
    url: "/track-application",
    title: "Track Your Request",
    description:
      "Use your Ehi's Tech Computer Services tracking code to view your product or service request status.",
  },
};
        ...
        <div className="section-shell grid items-start gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-700">
              Enter the tracking code you received after submitting your request to view the
            ...
            <div className="mt-8 rounded bg-white p-5 shadow-sm ring-1 ring-blue-100">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Your code appears after a successful request submission and is also included in
